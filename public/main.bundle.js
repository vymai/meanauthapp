...
var AuthService = (function () {
    ...
    AuthService.prototype.registerUser = function (user) {
        ...
        return this.http.post('users/register', user, { headers: headers }) //add localhost:3000/ if local
    ...
    AuthService.prototype.storeUserData = function (token, user) {
        ...
        localStorage.setItem('user', JSON.stringify(user)); // make a string
